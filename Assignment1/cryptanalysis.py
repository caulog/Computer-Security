...
print("---Get Vigenere Output---\n")
print(f"Output for get_vigenere_keyword on Message 1 with a key size of 5: {get_vigenere_keyword(message1, 5, expected_dist)}")
print(f"Output for get_vigenere_keyword on Message 2 with a key size of 8: {get_vigenere_keyword(message2, 8, expected_dist)}")
print(f"Output for get_vigenere_keyword on Message 3 with a key size of 7: {get_vigenere_keyword(message3, 7, expected_dist)}")
print("\n----------------------")
...
# LOOP THROUGH IN ORDER TO GET THE KEY SIZE
#for i in range(10):
    #print(get_vigenere_keyword(message2, i, expected_dist))
